...
url = 'https://www.bne.com.br/vagas-de-emprego/ti?Page='
headers = {
...
for i in range(1,int(65)):
    url_pag = f'https://www.bne.com.br/vagas-de-emprego/ti?Page={i}'
    site = requests.get(url_pag, headers=headers)
    soup = BeautifulSoup(site.content, 'html.parser')
    placas = soup.find_all('div', class_='job')

    with open ('31ti.csv','a',newline='', encoding='utf-8') as f:
